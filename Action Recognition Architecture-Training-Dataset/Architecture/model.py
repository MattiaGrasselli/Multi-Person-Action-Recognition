...
class TwoStreamArchitecture(nn.Module):
    ...
    def forward(self,x,y):        
        ...
        out1=torch.FloatTensor(x.shape[0],512,x.shape[2],8,4).cuda()
        out2=torch.FloatTensor(y.shape[0],512,y.shape[2],8,4).cuda()
        ...
        #print(out1.shape)
        #print(out2.shape)
        out=self._fusion(out1,out2).cuda()
